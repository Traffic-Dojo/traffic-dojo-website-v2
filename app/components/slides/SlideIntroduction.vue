...
<template>
  <AppSection id="introduction">
    ...
    <motion.div
      class="flex h-full flex-col items-center justify-center text-center lg:grid lg:grid-cols-2 lg:content-center lg:gap-20 lg:text-left"
      :variants="variants"
      initial="initial"
    ...
    >
      <motion.div
        ...
        :variants="variants"
      >
        <img src="~/assets/images/logo.png" alt="Traffic Dojo Logo" />
